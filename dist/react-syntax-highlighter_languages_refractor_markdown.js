(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  [78],
  {
    OniS: function (n, e, t) {
        ...
        (function (n) {
          ...
          (n.languages.markdown = n.languages.extend('markup', {})),
            ...
            n.hooks.add('after-tokenize', function (n) {
                  ...
                  for (var t = 0, a = n.length; t < a; t++) {
                    ...
                    if ('code' === i.type) {
                      ...
                      if (
                        ...
                        var s =
                          'language-' +
                          r.content.trim().split(/\s+/)[0].toLowerCase();
                        o.alias
              ...
              ('markdown' !== n.language && 'md' !== n.language) || e(n.tokens);
            }),
            n.hooks.add('wrap', function (e) {
              if ('code-block' === e.type) {
                ...
                var s = n.languages[t];
                if (s) {
                  var l = e.content.value
                    .replace(/&lt;/g, '<')
                    .replace(/&amp;/g, '&');
                  e.content = n.highlight(l, s, t);
      ...
      (n.exports = a), (a.displayName = 'markdown'), (a.aliases = ['md']);
    },
  },
]);
