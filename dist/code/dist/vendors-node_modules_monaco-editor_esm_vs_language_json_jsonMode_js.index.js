...
(self['webpackChunkreact_monaco_editor_browser_example'] =
  self['webpackChunkreact_monaco_editor_browser_example'] || []).push([
  ['vendors-node_modules_monaco-editor_esm_vs_language_json_jsonMode_js'],
  {
    '../../node_modules/monaco-editor/esm/vs/language/json/jsonMode.js': (
      ...
      n.r(t),
        n.d(t, {
          CompletionAdapter: () => Ce,
          DefinitionAdapter: () => Fe,
          DiagnosticsAdapter: () => we,
          DocumentColorAdapter: () => Be,
          DocumentFormattingEditProvider: () => ze,
          DocumentHighlightAdapter: () => Pe,
          DocumentLinkAdapter: () => Ke,
          DocumentRangeFormattingEditProvider: () => qe,
          DocumentSymbolAdapter: () => Ve,
          FoldingRangeAdapter: () => $e,
          HoverAdapter: () => Re,
          ReferenceAdapter: () => Ne,
          RenameAdapter: () => We,
          SelectionRangeAdapter: () => Je,
          WorkerManager: () => O,
          fromPosition: () => ye,
          fromRange: () => Ee,
          setupMode: () => wt,
          ...
          if ((t && 'object' === typeof t) || 'function' === typeof t)
            for (let c of a(t))
              s.call(e, c) ||
                ...
                i(e, c, {
                  get: () => t[c],
                  enumerable: !(r = o(t, c)) || r.enumerable,
                });
          return e;
        },
        u = {};
      ...
      var d,
        ...
        O = class {
          ...
          _checkIfIdle() {
            ...
            let e = Date.now() - this._lastUsedTime;
            e > F && this._stopWorker();
          }
          _getClient() {
            return (
      ...
      (function (e) {
        ...
        (function (e) {
          function t(e, t) {
            return (
              ...
              t === Number.MAX_VALUE && (t = g.MAX_VALUE),
              { line: e, character: t }
            );
          }
          function n(e) {
        ...
        (function (e) {
          ...
          function n(e) {
            var t = e;
            return ve.objectLiteral(t) && l.is(t.start) && l.is(t.end);
          }
          (e.create = t), (e.is = n);
        })(f || (f = {})),
        (function (e) {
        ...
        (function (e) {
          ...
          function n(e) {
            ...
            return (
              ve.string(t.label) &&
              (ve.undefined(t.textEdit) || I.is(t)) &&
              (ve.undefined(t.additionalTextEdits) ||
                ve.typedArray(t.additionalTextEdits, I.is))
            );
          }
          (e.create = t), (e.is = n);
        })(_ || (_ = {})),
        ...
        (function (e) {
          ...
          function n(e) {
            ...
            return (
              ...
              ve.uinteger(t.startLine) &&
              (ve.undefined(t.startCharacter) ||
                ve.uinteger(t.startCharacter)) &&
        ...
        (function (e) {
          ...
          function n(e) {
            var t = e;
            return ve.defined(t) && h.is(t.location) && ve.string(t.message);
          }
          (e.create = t), (e.is = n);
        })(k || (k = {})),
        (function (e) {
        ...
        (function (e) {
          function t(e, t, n, r, i, o) {
            ...
            return (
              ve.defined(n) && (a.severity = n),
              ve.defined(r) && (a.code = r),
              ve.defined(i) && (a.source = i),
              ve.defined(o) && (a.relatedInformation = o),
              a
            );
          }
          function n(e) {
            ...
            return (
              ...
              (ve.undefined(n.relatedInformation) ||
                ve.typedArray(n.relatedInformation, k.is))
            );
          }
          (e.create = t), (e.is = n);
        })(A || (A = {})),
        ...
        (function (e) {
          ...
          function i(e) {
            var t = e;
            return ve.objectLiteral(t) && ve.string(t.newText) && f.is(t.range);
          }
        ...
        (function (e) {
          ...
          function i(e) {
            var t = e;
            return I.is(t) && (S.is(t.annotationId) || T.is(t.annotationId));
          }
          (e.replace = t), (e.insert = n), (e.del = r), (e.is = i);
        })(R || (R = {})),
        (function (e) {
          ...
          function n(e) {
            var t = e;
            return (
              ve.defined(t) && U.is(t.textDocument) && Array.isArray(t.edits)
            );
          }
          (e.create = t), (e.is = n);
        })(D || (D = {})),
        ...
        Object.defineProperty(e.prototype, 'edit', {
            ...
            if (U.is(e)) {
              ...
              if (!n) {
                ...
                this._workspaceEdit.documentChanges.push(i),
                  (n = new pe(r, this._changeAnnotations)),
          ...
          (e.prototype.createFile = function (e, t, n) {
            ...
            if (
              ...
              void 0 === r
                ? (i = j.create(e, n))
                : ((o = T.is(r) ? r : this._changeAnnotations.manage(r)),
                  (i = j.create(e, n, o))),
              this._workspaceEdit.documentChanges.push(i),
              void 0 !== o)
            )
          ...
          (e.prototype.renameFile = function (e, t, n, r) {
            ...
            var i, o, a;
            if (
              (S.is(n) || T.is(n) ? (i = n) : (r = n),
              void 0 === i
                ? (o = M.create(e, t, r))
                : ((a = T.is(i) ? i : this._changeAnnotations.manage(i)),
                  (o = M.create(e, t, r, a))),
      ...
      (function (e) {
        ...
        (function (e) {
          function t(e) {
            var t = e;
            return ve.objectLiteral(e) && H.is(t.kind) && ve.string(t.value);
          }
          e.is = t;
        })(K || (K = {})),
        (function (e) {
        ...
        (function (e) {
          ...
          function n(e) {
            var t = e;
            return (
              t && ve.string(t.newText) && f.is(t.insert) && f.is(t.replace)
            );
          }
          (e.create = t), (e.is = n);
        })(B || (B = {})),
        ...
        (function (e) {
          ...
          function n(e) {
            ...
            return (
              ve.defined(t) &&
              ve.typedArray(t.diagnostics, A.is) &&
        ...
        (function (e) {
          ...
          function n(e) {
            ...
            return (
              ve.defined(t) &&
              f.is(t.range) &&
              (ve.undefined(t.command) || x.is(t.command))
            );
          }
          (e.create = t), (e.is = n);
        })(de || (de = {})),
        ...
        (function (e) {
          ...
          function i(e, t) {
            ...
            while (a < r.length) e[c++] = r[a++];
            while (s < o.length) e[c++] = o[s++];
            return e;
          }
      ...
      var we = class {
        constructor(e, t, n) {
          (this._languageId = e), (this._worker = t);
          const r = (e) => {
              let t,
                n = e.getLanguageId();
              n === this._languageId &&
            ...
            i = (e) => {
              u.editor.setModelMarkers(e, this._languageId, []);
              let t = e.uri.toString(),
                n = this._listener[t];
              n && (n.dispose(), delete this._listener[t]);
            };
          this._disposables.push(u.editor.onDidCreateModel(r)),
            this._disposables.push(u.editor.onWillDisposeModel(i)),
            this._disposables.push(
              u.editor.onDidChangeModelLanguage((e) => {
                i(e.model), r(e.model);
              }),
            ),
            this._disposables.push(
              n((e) => {
                u.editor.getModels().forEach((e) => {
        ...
        _doValidate(e, t) {
          this._worker(e)
            ...
            .then((n) => {
              const r = n.map((t) => ke(e, t));
              let i = u.editor.getModel(e);
              i && i.getLanguageId() === t && u.editor.setModelMarkers(i, t, r);
            })
            .then(void 0, (e) => {
              console.error(e);
            });
      ...
      var Ce = class {
        ...
        provideCompletionItems(e, t, n, r) {
          ...
          return this._worker(i)
            .then((e) => e.doComplete(i.toString(), ye(t)))
            .then((n) => {
              if (!n) return;
                ...
                o = n.items.map((e) => {
                  ...
                  return (
                    e.textEdit &&
                      (xe(e.textEdit)
                        ? (t.range = {
                            insert: Ae(e.textEdit.insert),
                            replace: Ae(e.textEdit.replace),
                          })
                        : (t.range = Ae(e.textEdit.range)),
                      (t.insertText = e.textEdit.newText)),
                    e.additionalTextEdits &&
                      (t.additionalTextEdits = e.additionalTextEdits.map(Se)),
                    e.insertTextFormat === q.Snippet &&
                      (t.insertTextRules =
                        u.languages.CompletionItemInsertTextRule.InsertAsSnippet),
                    t
                  );
                });
      ...
      function Ie(e) {
        const t = u.languages.CompletionItemKind;
        switch (e) {
          case z.Text:
            return t.Text;
          case z.Method:
      ...
      function Se(e) {
        if (e) return { range: Ae(e.range), text: e.newText };
      }
      function Te(e) {
      ...
      var Re = class {
        ...
        provideHover(e, t, n) {
          ...
          return this._worker(r)
            .then((e) => e.doHover(r.toString(), ye(t)))
            .then((e) => {
              if (e) return { range: Ae(e.range), contents: Me(e.contents) };
            });
        }
      };
      function De(e) {
      ...
      function Me(e) {
        if (e) return Array.isArray(e) ? e.map(je) : [je(e)];
      }
      var Pe = class {
        constructor(e) {
          this._worker = e;
        ...
        provideDocumentHighlights(e, t, n) {
          const r = e.uri;
          return this._worker(r)
            .then((e) => e.findDocumentHighlights(r.toString(), ye(t)))
            .then((e) => {
              if (e)
                return e.map((e) => ({ range: Ae(e.range), kind: Le(e.kind) }));
            });
        }
      };
      function Le(e) {
      ...
      var Fe = class {
        ...
        provideDefinition(e, t, n) {
          const r = e.uri;
          return this._worker(r)
            .then((e) => e.findDefinition(r.toString(), ye(t)))
            .then((e) => {
              if (e) return [Oe(e)];
            });
        }
      ...
      function Oe(e) {
        return { uri: u.Uri.parse(e.uri), range: Ae(e.range) };
      }
      var Ne = class {
          constructor(e) {
            this._worker = e;
          ...
          provideReferences(e, t, n, r) {
            const i = e.uri;
            return this._worker(i)
              .then((e) => e.findReferences(i.toString(), ye(t)))
              .then((e) => {
                if (e) return e.map(Oe);
              });
          }
        },
        We = class {
          ...
          provideRenameEdits(e, t, n, r) {
            const i = e.uri;
            return this._worker(i)
              .then((e) => e.doRename(i.toString(), ye(t), n))
              .then((e) => Ue(e));
          }
        };
      function Ue(e) {
        ...
        for (let n in e.changes) {
          const r = u.Uri.parse(n);
          for (let i of e.changes[n])
            t.push({
              resource: r,
              edit: { range: Ae(i.range), text: i.newText },
            });
        }
        return { edits: t };
      }
            ...
            .then((e) => {
              if (e)
                return e.map((e) => ({
                  ...
                  kind: He(e.kind),
                  range: Ae(e.location.range),
                  selectionRange: Ae(e.location.range),
                  tags: [],
                }));
            });
        }
        ...
        ze = class {
          ...
          provideDocumentFormattingEdits(e, t, n) {
            ...
            return this._worker(r).then((e) =>
              e.format(r.toString(), null, Xe(t)).then((e) => {
        ...
        qe = class {
          ...
          provideDocumentRangeFormattingEdits(e, t, n, r) {
            ...
            return this._worker(i).then((e) =>
              e.format(i.toString(), Ee(t), Xe(n)).then((e) => {
                if (e && 0 !== e.length) return e.map(Se);
              }),
            );
          }
      ...
      var Be = class {
          ...
          provideDocumentColors(e, t) {
            ...
            return this._worker(n)
              ...
              .then((e) => {
                if (e)
                  return e.map((e) => ({ color: e.color, range: Ae(e.range) }));
              });
          }
          provideColorPresentations(e, t, n) {
            ...
            return this._worker(r)
              .then((e) =>
                e.getColorPresentations(r.toString(), t.color, Ee(t.range)),
              )
              .then((e) => {
                if (e)
                  return e.map((e) => {
                    let t = { label: e.label };
                    return (
                      e.textEdit && (t.textEdit = Se(e.textEdit)),
                      e.additionalTextEdits &&
                        (t.additionalTextEdits = e.additionalTextEdits.map(Se)),
                      t
                    );
              ...
              .then((e) => {
                if (e)
                  return e.map((e) => {
                    ...
                    return (
                      'undefined' !== typeof e.kind && (t.kind = Qe(e.kind)), t
                    );
                  });
              });
          }
      ...
      var Ge,
        Je = class {
          ...
          provideSelectionRanges(e, t, n) {
            const r = e.uri;
            return this._worker(r)
              .then((e) => e.getSelectionRanges(r.toString(), t.map(ye)))
              .then((e) => {
                if (e)
                  return e.map((e) => {
                    const t = [];
                    while (e) t.push({ range: Ae(e.range) }), (e = e.parent);
                    return t;
                  });
              });
          }
      ...
      function Ye(e, t) {
        ...
        function h() {
          ...
          if (48 === e.charCodeAt(r)) r++;
            ...
            r++;
            while (r < e.length && tt(e.charCodeAt(r))) r++;
          }
          if (r < e.length && 46 === e.charCodeAt(r)) {
            if ((r++, !(r < e.length && tt(e.charCodeAt(r)))))
          ...
          while (1) {
            ...
            if (92 !== o) {
              ...
              switch (a) {
                ...
                case 117:
                  var s = l(4, !0);
                  s >= 0 ? (t += String.fromCharCode(s)) : (g = 4);
                  break;
                default:
                  g = 5;
              }
          ...
          switch (t) {
            ...
            case 47:
              ...
              if (47 === e.charCodeAt(r + 1)) {
                r += 2;
                while (r < n) {
                  if (et(e.charCodeAt(r))) break;
                  r++;
                }
                return (i = e.substring(l, r)), (a = 12);
              }
              if (42 === e.charCodeAt(r + 1)) {
                ...
                while (r < f) {
                  ...
                  r++,
                    et(_) &&
                      (13 === _ && 10 === e.charCodeAt(r) && r++, s++, (u = r));
                }
                return m || (r++, (g = 1)), (i = e.substring(l, r)), (a = 13);
              }
      ...
      function rt(e) {
        return {
          getInitialState: () => new mt(null, null, !1, null),
          tokenize: (t, n) => vt(e, t, n),
        };
      }
      var it = 'delimiter.bracket.json',
        ot = 'delimiter.array.json',
        at = 'delimiter.colon.json',
        st = 'delimiter.comma.json',
        ct = 'keyword.json',
        ut = 'keyword.json',
        dt = 'string.value.json',
        gt = 'number.json',
        lt = 'string.key.json',
        ft = 'comment.block.json',
        ht = 'comment.line.json',
        pt = class {
          constructor(e, t) {
          ...
          equals(e) {
            return (
              ...
              (!!(e && e instanceof mt) &&
                ...
                pt.equals(this.parents, e.parents))
            );
          }
          getStateData() {
            return this._state;
      ...
      function vt(e, t, n, r = 0) {
        ...
        while (1) {
          ...
          switch ((o && (d -= i), (o = i > 0), l)) {
            case 1:
              (c = pt.push(c, 0)), (g = it), (s = !1);
              break;
            case 2:
              (c = pt.pop(c)), (g = it), (s = !1);
              break;
            case 3:
              (c = pt.push(c, 1)), (g = ot), (s = !1);
              break;
            case 4:
              (c = pt.pop(c)), (g = ot), (s = !1);
              break;
          ...
          (u.endState = new mt(n.getStateData(), a.getTokenError(), s, c)),
            u.tokens.push({ startIndex: d, scopes: g });
        }
        return u;
      }
      var _t = class extends we {
        constructor(e, t, n) {
          super(e, t, n.onDidChange),
            this._disposables.push(
              u.editor.onWillDisposeModel((e) => {
      ...
      function wt(e) {
        ...
        function o() {
          ...
          kt(n),
            ...
            r.completionItems &&
              n.push(
                u.languages.registerCompletionItemProvider(
                  t,
                  new Ce(i, [' ', ':', '"']),
                ),
              ),
            r.hovers && n.push(u.languages.registerHoverProvider(t, new Re(i))),
            r.documentSymbols &&
              n.push(u.languages.registerDocumentSymbolProvider(t, new Ve(i))),
            r.tokens && n.push(u.languages.setTokensProvider(t, rt(!0))),
            r.colors && n.push(u.languages.registerColorProvider(t, new Be(i))),
            r.foldingRanges &&
              n.push(u.languages.registerFoldingRangeProvider(t, new $e(i))),
            r.diagnostics && n.push(new _t(t, i, e)),
            r.selectionRanges &&
              n.push(u.languages.registerSelectionRangeProvider(t, new Je(i)));
        }
        o(), t.push(u.languages.setLanguageConfiguration(e.languageId, Ct));
