  ...
  \*************************************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ DocumentColorAdapter: () =>
            /* binding */ DocumentColorAdapter,
          /* harmony export */ DocumentFormattingEditProvider: () =>
            /* binding */ DocumentFormattingEditProvider,
          /* harmony export */ DocumentHighlightAdapter: () =>
            /* binding */ DocumentHighlightAdapter,
          /* harmony export */ DocumentLinkAdapter: () =>
            /* binding */ DocumentLinkAdapter,
          /* harmony export */ DocumentRangeFormattingEditProvider: () =>
            /* binding */ DocumentRangeFormattingEditProvider,
          /* harmony export */ DocumentSymbolAdapter: () =>
            /* binding */ DocumentSymbolAdapter,
          /* harmony export */ FoldingRangeAdapter: () =>
            /* binding */ FoldingRangeAdapter,
          ...
          /* harmony export */ SelectionRangeAdapter: () =>
            /* binding */ SelectionRangeAdapter,
        ...
        var DiagnosticsAdapter = class {
          constructor(_languageId, _worker, configChangeEvent) {
            ...
            this._disposables.push(
              monaco_editor_core_exports.editor.onDidCreateModel(onModelAdd),
            );
            this._disposables.push(
          ...
          _doValidate(resource, languageId) {
            this._worker(resource)
              ...
              .then((diagnostics) => {
                ...
                let model =
                  monaco_editor_core_exports.editor.getModel(resource);
        ...
        function toDiagnostics(resource, diag) {
          let code =
            typeof diag.code === 'number' ? String(diag.code) : diag.code;
          return {
                ...
                const items = info.items.map((entry) => {
                  ...
                  if (entry.insertTextFormat === InsertTextFormat.Snippet) {
                    item.insertTextRules =
                      monaco_editor_core_exports.languages.CompletionItemInsertTextRule.InsertAsSnippet;
                  }
                  return item;
                });
                return {
        ...
        function isInsertReplaceEdit(edit) {
          return (
            typeof edit.insert !== 'undefined' &&
            typeof edit.replace !== 'undefined'
          );
        }
        function toCompletionItemKind(kind) {
          const mItemKind =
            monaco_editor_core_exports.languages.CompletionItemKind;
          switch (kind) {
        ...
        function isMarkupContent(thing) {
          return (
            thing && typeof thing === 'object' && typeof thing.kind === 'string'
          );
        }
        ...
        function toDocumentHighlightKind(kind) {
          switch (kind) {
            case DocumentHighlightKind.Read:
              return monaco_editor_core_exports.languages.DocumentHighlightKind
                .Read;
        ...
        function toFoldingRangeKind(kind) {
          switch (kind) {
            case FoldingRangeKind.Comment:
              return monaco_editor_core_exports.languages.FoldingRangeKind
                .Comment;
        ...
        function setupMode(defaults) {
          ...
          function registerProviders() {
            const { languageId, modeConfiguration: modeConfiguration2 } =
              defaults;
            ...
            if (modeConfiguration2.tokens) {
              providers.push(
                monaco_editor_core_exports.languages.setTokensProvider(
                  languageId,
          ...
          registerProviders();
          disposables.push(
            monaco_editor_core_exports.languages.setLanguageConfiguration(
              defaults.languageId,
