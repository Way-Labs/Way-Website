  ...
  \*****************************************************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ CodeActionAdaptor: () =>
            /* binding */ CodeActionAdaptor,
          /* harmony export */ DefinitionAdapter: () =>
            /* binding */ DefinitionAdapter,
          /* harmony export */ DiagnosticsAdapter: () =>
            /* binding */ DiagnosticsAdapter,
          /* harmony export */ FormatAdapter: () => /* binding */ FormatAdapter,
          /* harmony export */ FormatHelper: () => /* binding */ FormatHelper,
          /* harmony export */ FormatOnTypeAdapter: () =>
            /* binding */ FormatOnTypeAdapter,
          /* harmony export */ InlayHintsAdapter: () =>
            /* binding */ InlayHintsAdapter,
          /* harmony export */ Kind: () => /* binding */ Kind,
          /* harmony export */ LibFiles: () => /* binding */ LibFiles,
          /* harmony export */ OccurrencesAdapter: () =>
            /* binding */ OccurrencesAdapter,
          /* harmony export */ OutlineAdapter: () =>
            /* binding */ OutlineAdapter,
          /* harmony export */ QuickInfoAdapter: () =>
            /* binding */ QuickInfoAdapter,
          /* harmony export */ ReferenceAdapter: () =>
            /* binding */ ReferenceAdapter,
          /* harmony export */ RenameAdapter: () => /* binding */ RenameAdapter,
          /* harmony export */ SignatureHelpAdapter: () =>
            /* binding */ SignatureHelpAdapter,
          /* harmony export */ SuggestAdapter: () =>
            /* binding */ SuggestAdapter,
          /* harmony export */ WorkerManager: () => /* binding */ WorkerManager,
          /* harmony export */ flattenDiagnosticMessageText: () =>
            /* binding */ flattenDiagnosticMessageText,
          /* harmony export */ getJavaScriptWorker: () =>
            /* binding */ getJavaScriptWorker,
          /* harmony export */ getTypeScriptWorker: () =>
            /* binding */ getTypeScriptWorker,
          /* harmony export */ setupJavaScript: () =>
            /* binding */ setupJavaScript,
          /* harmony export */ setupTypeScript: () =>
            /* binding */ setupTypeScript,
          /* harmony export */
        });
        /* harmony import */ var _editor_editor_api_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../../editor/editor.api.js */ 'include-loader!../../node_modules/monaco-editor/esm/vs/editor/editor.api.js',
          );
        /* harmony import */ var _monaco_contribution_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./monaco.contribution.js */ '../../node_modules/monaco-editor/esm/vs/language/typescript/monaco.contribution.js',
          );
        /*!-----------------------------------------------------------------------------
                ...
                p = p.then((worker) => {
                  if (this._worker) {
                    return this._worker.withSyncedResources(
                      monaco_editor_core_exports.editor
                        .getModels()
                        .filter(
                          (model) => model.getLanguageId() === this._modeId,
                        )
                        .map((model) => model.uri),
                    );
                  }
        ...
        var LibFiles = class {
          ...
          getOrCreateModel(fileName) {
            ...
            if (this.isLibFile(uri) && this._hasFetchedLibFiles) {
              return monaco_editor_core_exports.editor.createModel(
                this._libFiles[uri.path.slice(1)],
                'typescript',
                uri,
              );
            }
            const matchedLibFile =
              _monaco_contribution_js__WEBPACK_IMPORTED_MODULE_1__.typescriptDefaults.getExtraLibs()[
                fileName
              ];
            if (matchedLibFile) {
              return monaco_editor_core_exports.editor.createModel(
        ...
        var DiagnosticsAdapter = class extends Adapter {
          constructor(_libFiles, _defaults, _selector, worker) {
            ...
            this._disposables.push(
              monaco_editor_core_exports.editor.onDidCreateModel((model) =>
                onModelAdd(model),
              ),
            );
            this._disposables.push(
              monaco_editor_core_exports.editor.onWillDisposeModel(
                onModelRemoved,
              ),
            );
            this._disposables.push(
              monaco_editor_core_exports.editor.onDidChangeModelLanguage(
                (event) => {
            ...
            this._disposables.push(
              this._defaults.onDidChange(recomputeDiagostics),
            );
            this._disposables.push(
            ...
            monaco_editor_core_exports.editor
              .getModels()
              .forEach((model) => onModelAdd(model));
          }
          _disposables = [];
            ...
            const relatedUris = diagnostics
              ...
              .map((relatedInformation) =>
                relatedInformation.file
                  ? monaco_editor_core_exports.Uri.parse(
        ...
        var SuggestAdapter = class extends Adapter {
          ...
          async provideCompletionItems(model, position, _context, token) {
            ...
            const suggestions = info.entries.map((entry) => {
              ...
              if (entry.replacementSpan) {
                ...
                range = new monaco_editor_core_exports.Range(
                  p1.lineNumber,
                  p1.column,
                  p2.lineNumber,
                  p2.column,
              ...
              if (entry.kindModifiers?.indexOf('deprecated') !== -1) {
                tags.push(
                  monaco_editor_core_exports.languages.CompletionItemTag
                    .Deprecated,
                );
              }
              return {
          ...
          static convertKind(kind) {
            switch (kind) {
              ...
              case Kind.keyword:
                return monaco_editor_core_exports.languages.CompletionItemKind
                  .Keyword;
              case Kind.variable:
          ...
          static createDocumentationString(details) {
            let documentationString = displayPartsToString(
...
${tagToString(tag)}`;
        ...
        var SignatureHelpAdapter = class extends Adapter {
          ...
          static _toSignatureHelpTriggerReason(context) {
            switch (context.triggerKind) {
              case monaco_editor_core_exports.languages.SignatureHelpTriggerKind
                .TriggerCharacter:
            ...
            return entries.map((entry) => {
              return {
                ...
                kind: entry.isWriteAccess
                  ? monaco_editor_core_exports.languages.DocumentHighlightKind
                      .Write
                  : monaco_editor_core_exports.languages.DocumentHighlightKind
                      .Text,
              };
        ...
        var DefinitionAdapter = class extends Adapter {
          ...
          async provideDefinition(model, position, token) {
            ...
            await this._libFiles.fetchLibFilesIfNecessary(
              entries.map((entry) =>
                monaco_editor_core_exports.Uri.parse(entry.fileName),
              ),
            );
            if (model.isDisposed()) {
              return;
        ...
        var OutlineAdapter = class extends Adapter {
          async provideDocumentSymbols(model, token) {
            ...
            const items = await worker.getNavigationBarItems(
              resource.toString(),
            );
            ...
            const convert = (bucket, item, containerLabel) => {
              let result2 = {
                ...
                kind:
                  ...
                  monaco_editor_core_exports.languages.SymbolKind.Variable,
        ...
        outlineTypeTable[Kind.module] =
          monaco_editor_core_exports.languages.SymbolKind.Module;
        outlineTypeTable[Kind.class] =
          monaco_editor_core_exports.languages.SymbolKind.Class;
        outlineTypeTable[Kind.enum] =
          monaco_editor_core_exports.languages.SymbolKind.Enum;
        outlineTypeTable[Kind.interface] =
          monaco_editor_core_exports.languages.SymbolKind.Interface;
        outlineTypeTable[Kind.memberFunction] =
          monaco_editor_core_exports.languages.SymbolKind.Method;
        outlineTypeTable[Kind.memberVariable] =
          monaco_editor_core_exports.languages.SymbolKind.Property;
        outlineTypeTable[Kind.memberGetAccessor] =
          monaco_editor_core_exports.languages.SymbolKind.Property;
        outlineTypeTable[Kind.memberSetAccessor] =
          monaco_editor_core_exports.languages.SymbolKind.Property;
        outlineTypeTable[Kind.variable] =
          monaco_editor_core_exports.languages.SymbolKind.Variable;
        outlineTypeTable[Kind.const] =
          monaco_editor_core_exports.languages.SymbolKind.Variable;
        outlineTypeTable[Kind.localVariable] =
          monaco_editor_core_exports.languages.SymbolKind.Variable;
        outlineTypeTable[Kind.variable] =
          monaco_editor_core_exports.languages.SymbolKind.Variable;
        outlineTypeTable[Kind.function] =
          monaco_editor_core_exports.languages.SymbolKind.Function;
        outlineTypeTable[Kind.localFunction] =
          monaco_editor_core_exports.languages.SymbolKind.Function;
        ...
        var CodeActionAdaptor = class extends FormatHelper {
          async provideCodeActions(model, range, context, token) {
            ...
            const formatOptions = FormatHelper._convertOptions(
              model.getOptions(),
            );
            ...
            const actions = codeFixes
              .filter((fix) => {
                return (
                  fix.changes.filter((change) => change.isNewFile).length === 0
                );
              })
              .map((fix) => {
        ...
        var InlayHintsAdapter = class extends Adapter {
          async provideInlayHints(model, range, token) {
            ...
            const tsHints = await worker.provideInlayHints(
              fileName,
              start,
              end,
            );
          ...
          _convertHintKind(kind) {
            switch (kind) {
              case 'Parameter':
                return monaco_editor_core_exports.languages.InlayHintKind
                  .Parameter;
              case 'Type':
        ...
        function setupMode(defaults, modeId) {
          ...
          monaco_editor_core_exports.languages.registerCodeActionProvider(
            modeId,
          ...
          monaco_editor_core_exports.languages.registerInlayHintsProvider(
            modeId,
