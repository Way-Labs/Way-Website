!(function (e, t) {
        ...
        if (i)
          for (p = 0; p < c.length; p += 1) {
            ...
            e.dom7LiveListeners || (e.dom7LiveListeners = {}),
              ...
              e.dom7LiveListeners[t].push({ listener: r, proxyListener: l }),
      ...
      for (let o = 0; o < l.length; o += 1) {
        ...
        for (let t = 0; t < this.length; t += 1) {
          ...
          if (
            (!i && s.dom7Listeners
              ? (a = s.dom7Listeners[e])
              : i && s.dom7LiveListeners && (a = s.dom7LiveListeners[e]),
            a && a.length)
          )
            for (let t = a.length - 1; t >= 0; t -= 1) {
              ...
              (r &&
                ...
                ? (s.removeEventListener(e, i.proxyListener, n), a.splice(t, 1))
                : r ||
                  (s.removeEventListener(e, i.proxyListener, n),
                  a.splice(t, 1));
            }
        }
      }
    ...
    S = {
      ...
      updateSlides: function () {
        ...
        for (let v = 0; v < p; v += 1) {
          ...
          const i = c.eq(v);
          if (
            (C && e.grid.updateSlide(v, i, p, t), 'none' !== i.css('display'))
          ) {
            if ('auto' === a.slidesPerView) {
              ...
              if (
                ...
                $ = e.isHorizontal() ? i.outerWidth(!0) : i.outerHeight(!0);
              else {
                const e = s(r, 'width'),
                  t = s(r, 'padding-left'),
                  a = s(r, 'padding-right'),
              ...
              ($ = (r - (a.slidesPerView - 1) * x) / a.slidesPerView),
                a.roundLengths && ($ = Math.floor($)),
                c[v] && (c[v].style[t('width')] = `${$}px`);
            c[v] && (c[v].swiperSlideSize = $),
              m.push($),
              a.centeredSlides
                ? ((y = y + $ / 2 + E / 2 + x),
                  0 === E && 0 !== v && (y = y - r / 2 - x),
      ...
      updateSlidesProgress: function (e) {
        ...
        for (let l = 0; l < a.length; l += 1) {
          ...
          ((p >= 0 && p < t.size - 1) ||
            ...
            a.eq(l).addClass(s.slideVisibleClass)),
            (e.progress = i ? -d : d),
    ...
    z = {
      loopCreate: function () {
        ...
        for (let a = 0; a < o.length; a += 1)
          r.append(d(o[a].cloneNode(!0)).addClass(s.slideDuplicateClass));
        for (let a = l.length - 1; a >= 0; a -= 1)
          r.prepend(d(l[a].cloneNode(!0)).addClass(s.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
  ...
  function L(e) {
    ...
    for (
      let p = 0;
      p < n.length;
      p += p < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup
    ) {
      const e = p < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
      void 0 !== n[p + e]
        ? h >= n[p] && h < n[p + e] && ((m = p), (f = n[p + e] - n[p]))
        : h >= n[p] && ((m = p), (f = n[n.length - 1] - n[n.length - 2]));
    }
    let g = null,
      v = null;
    a.rewind &&
      ...
      breakpoints: {
        ...
        getBreakpoint: function (e, t, s) {
          ...
          for (let r = 0; r < l.length; r += 1) {
            ...
            'window' === t
              ? i.matchMedia(`(min-width: ${n}px)`).matches && (a = e)
              : n <= s.clientWidth && (a = e);
          }
          return a || 'max';
        },
    ...
    slidesPerViewDynamic(e, t) {
      ...
      if (s.centeredSlides) {
        ...
        for (let d = l + 1; d < a.length; d += 1)
          (t ? i[d] + r[d] - i[l] < n : i[d] - i[l] < n) && (o += 1);
      else for (let d = l - 1; d >= 0; d -= 1) i[l] - i[d] < n && (o += 1);
      return o;
    }
    update() {
      const e = this;
  ...
  const re = [
      ...
      function l(e) {
        ...
        if (e) s.$wrapperEl.find(`.${s.params.slideClass}`).remove();
          ...
          for (let r = d; r <= c; r += 1)
            (r < w || r > b) &&
              s.$wrapperEl
                .find(`.${s.params.slideClass}[data-swiper-slide-index="${r}"]`)
                .remove();
          ...
          if (
            ...
            if ((e.addClass(s.bulletActiveClass), s.dynamicBullets)) {
              const e = a.eq(i),
                n = a.eq(o);
              for (let t = i; t <= o; t += 1)
                a.eq(t).addClass(`${s.bulletActiveClass}-main`);
              if (t.params.loop)
                if (r >= a.length) {
    ...
    function (e) {
      ...
      function c() {
        ...
        else if (c > 1) for (let t = i; t < i + c; t += 1) p(t) && o(t);
        else o(i);
        if (n.loadPrevNext)
          if (c > 1 || (n.loadPrevNextAmount && n.loadPrevNextAmount > 1)) {
            ...
            for (let a = i + c; a < s; a += 1) p(a) && o(a);
            for (let a = r; a < i; a += 1) p(a) && o(a);
          } else {
    ...
    function (e) {
      ...
      function o(e) {
        ...
        if (
          ...
          for (let o = 0; o < n; o += 1)
            s.$wrapperEl
              .children(`[data-swiper-slide-index="${t.realIndex + o}"]`)
              .addClass(l);
        else
          for (let o = 0; o < n; o += 1)
            s.slides.eq(t.realIndex + o).addClass(l);
      }
        ...
        te({
          ...
          setTranslate: () => {
            const { width: e, height: s, slides: a, slidesSizesGrid: i } = t,
              ...
              c = r.depth;
            for (let t = 0, p = a.length; t < p; t += 1) {
              const e = a.eq(t),
                s = i[t],
                l = (o - e[0].swiperSlideOffset - s / 2) / s,
                p =
              ...
              if (
                ...
                let t = n
                  ...
                  s = n
                    ? e.find('.swiper-slide-shadow-right')
                    : e.find('.swiper-slide-shadow-bottom');
                0 === t.length && (t = ie(r, e, n ? 'left' : 'top')),
                  0 === s.length && (s = ie(r, e, n ? 'right' : 'bottom')),
        ...
        setTranslate: () => {
          ...
          for (let o = 0; o < e.length; o += 1) {
            ...
            if ((m && f.shadow) || !m) {
              ...
              if ((0 === e.length && f.shadow && (e = ie(r, s)), e.length)) {
